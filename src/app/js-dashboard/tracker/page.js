...
export default function CandidateUsageTracker() {
  return (
    <div className="p-4 md:p-10">
      <h2 className="text-2xl font-bold mb-10 text-gray-800">Usage Tracker</h2>
      <div className="flex flex-wrap gap-16">
        <UsageRing label="Applications" value={4} total={15} subtitle="16 Days Left" />
        <UsageRing label="Resume consulter" value={10} total={15} subtitle="16 Days Left" />
      </div>
    </div>
  );
}
